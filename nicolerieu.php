...
<HEAD>
<TITLE>Page Nicole Rieu du Site de La Marzina (en HTML) </TITLE>
<!-- meta (pour referencement) -->
    <meta name="description" content="Page Nicole Rieu" />
...
<TR>
   ...
   <TABLE CELLPADING="0" BORDER="0">
    ...
    <!-- colonne centrale --> 
    <TH ALIGN="CENTER">
        <!-- Affiche Ncicole RIEU -->  
               
		 <P> <IMG alt="Affiche Nicole Rieu" src="IMG/NicoleRieu_Essaion.jpg" /> </P>
   ...
   <TABLE CELLPADING="0" BORDER="0">
	...
	<!-- Lien interne sur page mediatheque.html --> 
        <strong>
          <A TITLE="Adh&eacute;sion Petite M&eacute;diath&egrave;que" HREF="nicolerieu.php#">Adh&eacute;sion</A>
        </stronG>
    </TR>
    <TR><br /></TR> 
